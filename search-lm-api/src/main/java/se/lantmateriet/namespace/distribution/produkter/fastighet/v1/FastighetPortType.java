 ...
 * 
 */
@WebService(name = "FastighetPortType", targetNamespace = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5")
...
public interface FastighetPortType {
    ...
    @WebResult(name = "RegisterenhetResponse", targetNamespace = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", partName = "RegisterenhetResponse")
    public RegisterenhetResponseType getRegisterenhet(
        @WebParam(name = "GetRegisterenhetRequest", targetNamespace = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", partName = "GetRegisterenhetRequest")
    ...
    @WebResult(name = "RegisterenhetsreferensResponse", targetNamespace = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", partName = "RegisterenhetsreferensResponse")
    public RegisterenhetsreferensResponseType findRegisterenhet(
        @WebParam(name = "FindRegisterenhetRequest", targetNamespace = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", partName = "FindRegisterenhetRequest")
