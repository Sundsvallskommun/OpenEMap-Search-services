 ...
 * 
 */
@WebServiceClient(name = "FastighetService", targetNamespace = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", wsdlLocation = "http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5/fastighet-1.5.0.wsdl")
    ...
    extends Service
{
    ...
    private final static QName FASTIGHETSERVICE_QNAME = new QName("http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", "FastighetService");
    ...
    public FastighetPortType getFastighetSoapBinding() {
        return super.getPort(new QName("http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", "FastighetSoapBinding"), FastighetPortType.class);
    }
    ...
    public FastighetPortType getFastighetSoapBinding(WebServiceFeature... features) {
        return super.getPort(new QName("http://namespace.lantmateriet.se/distribution/produkter/fastighet/v1.5", "FastighetSoapBinding"), FastighetPortType.class, features);
    }
