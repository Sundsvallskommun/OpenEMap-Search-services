...
/**
 * <p>Java class for AndelstalssortType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AndelstalssortType">
 ...
 * 
 */
@XmlType(name = "AndelstalssortType")
@XmlEnum
public enum AndelstalssortType {
    ...
    public static AndelstalssortType fromValue(String v) {
        for (AndelstalssortType c: AndelstalssortType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
