...
/**
 * posList instances (and other instances with the content model specified by DirectPositionListType)
 *         hold the coordinates for a sequence of direct positions within the same coordinate reference system (CRS).
 *         The CRS shall be specified as part of the larger context this geometry element is part of, typically a geometric
