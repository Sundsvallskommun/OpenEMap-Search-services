 ...
 *         element may have an identifying attribute (gml:id), one or more names (gml:name) and a
 *         description (gml:description) . It may be associated with a spatial reference
